...
@section('content')
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Medicines Recipe Data</h1>
    <p class="mb-4">Management Medicines Recipe</p>
    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                <button class="btn btn-sm btn-primary float-right" data-toggle="modal" data-target="#tambahData">Add
                    Data</button>
                </button>
            </h6>
        </div>
