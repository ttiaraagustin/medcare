...
class ResepObatController extends Controller
{
    ...
    public function index()
    {
        ...
        $obat       = Obat::all();
        $data = [
            'title'     => 'MedCare | Resep Obat',
            'resep'     => $resep,
            'berobat'   => $berobat,
            'obat'      => $obat,
        ];
        return view('pages.obat.resep.index', $data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.obat.resep.edit', $data);
    }
    ...
    public function destroy($id)
    {
        $resepObat  = ResepObat::findOrFail($id);
        $resepObat->delete();
        return redirect()->to(route('resep-obat.index'))->with('resepDelete', 'resep obat berhasil dihapus');
    }
}
